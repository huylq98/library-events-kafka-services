...
public class LibraryEventsConsumerIntegrationTest {
  ...
  @BeforeEach
  void setUp() {
    endpointRegistry.getListenerContainers().forEach(
  ...
  void publishNewLibraryEvent()
    ...
    // given
    String libraryEvent = "{\"id\":null,\"libraryEventType\":\"NEW\",\"book\":{\"id\":1,\"name\":\"The Black Phone\",\"author\":\"Joe Hill\"}}";
  ...
  void updateExistedLibraryEvent_withNullLibraryEventId()
    ...
    // then
    verify(libraryEventsConsumer, times(10)).onMessage(any(ConsumerRecord.class));
    verify(libraryEventsService, times(10)).process(any(ConsumerRecord.class));
  }
}
